...
export default function Header() {
    ...
    const NavLinks = () => (
        <>
            <Link className='nav-link mx-2' href={'/'}>דף הבית</Link>
            <Link className='nav-link mx-2' href={'/neighborhoodInfo'}>מידע שכונתי</Link>
            <Link className='nav-link mx-2' href={'/forum'}>פורומים</Link>
            <Link className='nav-link mx-2' href={'/'}>לכל המשפחה</Link>
            <Link className='nav-link mx-2' href={'/'}>נדלן</Link>
            <Link className='nav-link mx-2' href={'/'}>לוח</Link>
            <Link className='nav-link mx-2' href={'/'}>צור קשר</Link>
        </>
    );
        ...
        <div className='bg-light sticky-top shadow-sm'>
            <div className='container py-2'>
                <div className='row align-items-center'>
                    ...
                    <div className='col-4 col-md-8 order-md-2 text-center'>
                        <div className='d-md-none'>
                            <button className='btn btn-light' onClick={toggleNav}>
                                <i className="bi bi-list"></i>
                            </button>
                        </div>
                        <div className={`navbar-collapse ${isNavOpen ? 'show' : ''} d-md-block`}>
