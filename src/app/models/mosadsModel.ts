...
const mosadsSchema = new mongoose.Schema({
    userId: String,
    userName:String,
    name: String,
    description: String,
...
export const MosadsModel = mongoose.models["mosads"] || mongoose.model("mosads", mosadsSchema);



export const validateMosads = (_body: any) => {
